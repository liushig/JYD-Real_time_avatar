            ...
            try:
                ...
                if isinstance(event, Tts2FaceEvent):
                    if event == Tts2FaceEvent.SPEAKING_TO_LISTENING:
                        ...
                        # 发送 avatar_end 标志，直接通过 data_submitter 提交
                        ...
                        if text_def and self.data_submitter:
                            ...
                            logger.info(f"[Avatar结束] 发送 __AVATAR_END__ 标志")
...
class HandlerAvatarMusetalk(HandlerBase):
    def __init__(self) -> None:
        ...
        self.data_submitter = None  # 用于直接提交 avatar_end 信号
    ...
    def start_context(self, session_context: SessionContext, handler_context: HandlerContext):
        ...
        Start context.
        """
        handler_context = cast(AvatarMuseTalkContext, handler_context)
        self.data_submitter = handler_context.data_submitter
