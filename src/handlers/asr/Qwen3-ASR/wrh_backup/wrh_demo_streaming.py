...
# CUDA_VISIBLE_DEVICES=2 python3 -m qwen_asr.cli.demo_streaming --asr-model-path model/Qwen3-ASR-1.7B --gpu-memory-utilization 0.3 --port 7998
...
def main():
    ...
    asr = Qwen3ASRModel.LLM(
        ...
        max_new_tokens=32,
        # language="ko" # 👈 强制韩语                                                              无效，没有这个参数
        # system_prompt="Please transcribe the following speech in Korean language only."          无效，没有这个参数
    )
    print("Model loaded.")
