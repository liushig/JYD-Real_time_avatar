...
# CUDA_VISIBLE_DEVICES=2 python3 -m qwen_asr.cli.demo_streaming --asr-model-path model/Qwen3-ASR-1.7B --gpu-memory-utilization 0.3 --port 7999

# CUDA_VISIBLE_DEVICES=2 python qwen_asr/cli/demo_streaming.py   --asr-model-path /opt/jyd01/wangruihua/test/Qwen3-ASR/Qwen3-ASR-1.7B   --gpu-memory-utilization 0.3 --port 7999
