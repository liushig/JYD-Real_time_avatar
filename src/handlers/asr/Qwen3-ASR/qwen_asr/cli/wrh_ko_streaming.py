...
# CUDA_VISIBLE_DEVICES=2 python3 -m qwen_asr.cli.wrh_ko_streaming --asr-checkpoint model/Qwen3-ASR-1.7B --port 7998


# CUDA_VISIBLE_DEVICES=2 python3 wrh_qwen_streaming.py \
# --asr-checkpoint model/Qwen3-ASR-1.7B \
# --port 7998

# 完整实现，原名为 wrh_ko_streaming_transformers.py
