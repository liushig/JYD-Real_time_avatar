...
class SharedStates:
    ...
    vad_mode: str = "DISABLED"
    # === 新增 ===
    current_speech_id: str | None = None
    interrupt_flag: bool = False  # RTC 使用的打断信号
    button_interrupt_flag: bool = False  # 按钮点击打断信号
    tts_interrupt_flag: bool = False  # TTS 专用的打断信号（与 interrupt_flag 分离）
    avatar_interrupt_flag: bool = False  # 数字人专用的打断信号（与 interrupt_flag 分离）
    llm_interrupt_flag: bool = False  # LLM 专用的打断信号（与 interrupt_flag 分离）
    # === 新增：数字人渲染状态 ===
